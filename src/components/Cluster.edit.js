...
//console.log(e.target.value);
    ...
    submitCluster(e) {
        ...
        $.ajax({
            ...
            error:function(error){
                ...
                new ShowDiag({
                    msg: !data.info.warning?'编辑失败！':data.info.warning,
                    closetime: 2
                });
            },
            success: function (data) {
                ...
                if (data.info.status == "success") {
                    $('#d-editCluster-modal').modal('hide');
                    new ShowDiag({
                        msg: '编辑成功！',
                        closetime: 2
                    });
    ...
    render() {
       ...
       // console.log(cluster);
        return (
            <div className="modal fade f-modal" id='d-editCluster-modal'>
                <div className="modal-dialog" style={{minWidth:'1000px'}}>
                    <div className="modal-content">
                        <div className="f-modal-header">
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                            <h4 className="modal-title"><span className='glyphicon glyphicon-lock'></span> 修改集群</h4>
                        </div>
                                ...
                                <div className="form-group">
                                    <div className="col-xs-offset-1 col-xs-10">
                                        <table className="table f-table">
                                            <thead>
                                            <tr>
                                                <th rowSpan="2" style={{width:'10%'}}>层级</th>
                                                <th colSpan="2">设备组配置</th>
                                                <th rowSpan="2" style={{width:'132px'}}>操作</th>
                                            </tr>
                                            <tr>
                                                <th>设备组</th>
                                                <th>拓扑</th>
...
export default connect(sel)(EditCluster)