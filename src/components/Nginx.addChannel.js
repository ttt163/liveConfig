...
export default class NginxAdd extends Component {
    render() {
        return (
            <div className="modal fade f-modal resChosen" id='f-addChannel-modal' data-id="0">
                <div className="modal-dialog" style={{minWidth:'800px'}}>
                    <div className="modal-content">
                        ...
                        <div className="f-modal-body">
                            <form className="form-horizontal f-form-horizontal" id="Channel_add">
                                ...
                                <div className="form-group">
                                    <label  className="col-xs-2 control-label"><span className='red'>*</span> 频道：</label>
                                    <div className="col-xs-9">
