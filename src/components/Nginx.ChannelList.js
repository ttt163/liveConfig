...
export default class NginxChannelList extends Component {
    render() {
        return (
            <div className="modal fade f-modal" id='f-channelList-modal'>
                <div className="modal-dialog" style={{'minWidth':'800px'}}>
                    <div className="modal-content">
                        <div className="f-modal-header">
                            <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 className="modal-title"><span className='glyphicon glyphicon-lock'></span>频道列表</h4>
                        </div>
                            ...
                            <form className="form-horizontal f-form-horizontal" id="d_add" >
                                    ...
                                    <input id="send_type" type="hidden"/>
                                        <div className="form-group text-center" style={{'marginTop':'37px'}}>
                                            ...
                                            <button type='button' className="f-btn fbtn-miss ml15" data-dismiss="modal"><span className='fbtn-miss-svg'></span> 关闭</button>
                                        </div>
                            </form>
                        </div>
